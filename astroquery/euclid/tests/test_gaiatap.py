...
from astroquery.euclid.core import EuclidClass
from astroquery.euclid.tests.DummyTapHandler import DummyTapHandler
...
class TestTap(unittest.TestCase):
    ...
    def test_load_tables(self):
        ...
        tap = EuclidClass(dummyTapHandler)
        # default parameters
        parameters = {}
